        ...
        <div class="modal-content">
            ...
            <?php echo form_open_multipart('divisi_detail/divisi_detail_add'); ?>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <select name="divisi_id" id="divisi_id" required="required" class="form-control show-tick">
                     ...
                     <div class="form-group">
                        <div class="form-line">
                            <textarea rows="4" name="divisi_det_ringkasan" class="form-control no-resize" placeholder="Keterangan"></textarea>
                        </div>
                    </div>
