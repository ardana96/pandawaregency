			...
			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
				...
				<div class="post-content">
					...
					<div class="post-image-wrapper">
						<img src="<?php echo base_url(); ?>admin/images/kegiatan/<?= $kegiatan_detail['kegiatan_photo'];  ?>" class="img-responsive"  alt="" style="width:750px; height:450;"/>
						<?php $date = date_create($kegiatan_detail['created_date']) ;?>
						<span class="blog-date"><a href="#"> <?= date_format($date,"d F Y"); ?></a></span>
					</div><!-- post image end -->
					<div class="post-header clearfix">
						<h2 class="post-title">
							<a href="blog-item.html"><?php echo $kegiatan_detail['kegiatan_nama'];  ?></a>
						</h2>
						<div class="post-meta">
							<span class="post-meta-author">Posted by <a href="#"><?php echo $kegiatan_detail['created_by'];  ?></a></span>
							<span class="post-meta-cats"> in <a href="#"> Kegiatan </a></span>
							
							
						</div><!-- post meta end -->
					</div><!-- post heading end -->
					<div class="entry-content">
						<?php echo $kegiatan_detail['kegiatan_isi'];  ?>
					</div>
