                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <label>RINGKASAN</label>
                     <div class="form-group">
                        <div class="form-line">
                            <textarea rows="10" name="donasi_ringkasan" required="required" class="form-control no-resize"><?php echo $donasi['donasi_ringkasan']; ?></textarea>
                        </div>
                    </div>
                    ...
                    <label>STATUS PRIORITAS</label>
                     <div class="demo-radio-button">
                        ...
                        <?php if ($donasi['priority'] == 1) { ?>
                            <input name="priority" type="radio" id="radio_1" value=1 checked />
                            <label for="radio_1">PRIORITAS</label>
                            <input name="priority" type="radio" id="radio_2" value=2 />
                        ...
                        <?php } else { ?>
                            ...
                            <label for="radio_1">PRIORITAS</label>
                            <input name="priority" type="radio" id="radio_2" value=2 checked/>
                            <label for="radio_2">TIDAK PRIORITAS</label>
                        <?php } ?>     
                    </div>
