                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= strtoupper($row->kategori_status_nama) ?></td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart('kategori/kategori_add'); ?>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <select name="kategori_status_id" id="kategori_status_id" required="required" class="form-control show-tick">
                                <option value="">--  PILIH STATUS  --</option>
                                <?php foreach ($kategori_status_view as $row) {  ?>
                                <option value="<?= $row->kategori_status_id ?>"><?= $row->kategori_status_nama ?></option>
                              <?php } ?>
                            </select>
                        </div>
                    </div>  
